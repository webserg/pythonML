...
def train(net, data, epochs=10, batch_size=10, seq_length=50, lr=0.001, clip=5, val_frac=0.1, print_every=10):
    ...
    for e in range(epochs):
        ...
        for x, y in get_batches(data, batch_size, seq_length):
            ...
            if train_on_gpu:
                inputs, targets = inputs.cuda(), targets.to(device, dtype=torch.long)
...
if __name__ == '__main__':
    ...
    with open('C:/git/pythonML/pythonML/notebooks/Pytorch/recurrent-neural-networks/char-rnn/data/anna.txt', 'r') as f:
        text = f.read()
    print(text[:100])
