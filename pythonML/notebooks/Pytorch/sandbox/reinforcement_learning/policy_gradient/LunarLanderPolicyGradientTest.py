...
from pythonML.notebooks.Pytorch.sandbox.reinforcement_learning.policy_gradient.LunarLanderPolicyGradient import PolicyGradientNet
from pythonML.notebooks.Pytorch.sandbox.reinforcement_learning.policy_gradient.LunarLanderPolicyGradient import NetConfig
