...
class Policy(nn.Module):
    ...
    def __init__(self, state_size, num_actions):
        ...
        self.file_path = '../models/LunarLanderPGReinforce2.pt'
    ...
    def train(self, num_episodes):
        ...
        for e in range(num_episodes):
            ...
            if (e+1) % (self.save_freq) == 0:
                torch.save(self.policy.state_dict(), os.path.join(self.save_path, "luner_lander_train_ep_{}.pkl".format(e+1)))
...
def main():
    ...
    parser.add_argument("--save_freq", type=int, default=1000, help="checkpoint frequency for saving models")
    parser.add_argument("--test_freq", type=int, default=500, help="frequency for testing policy")
    parser.add_argument("--save_path", type=str, default="../../models/lunar_lander", help="path for saving models")
    parser.add_argument("--expt_name", type=str, default="../../models/lunar_lander", help="expt name for saving results")
