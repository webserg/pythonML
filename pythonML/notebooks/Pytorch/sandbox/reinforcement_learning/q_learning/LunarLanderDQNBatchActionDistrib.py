...
if __name__ == '__main__':
    ...
    gamma = 0.9
    epsilon = 0.3
    mem_size = 1500  # A  A Set the total size of the experience replay memory
    batch_size = 500  # B Set the minibatch size
    ...
    for i in range(MAX_EPISODES):  # B
        ...
        while not done:  # while in episode
            steps_couter += 1
            probs_batch = model(torch.from_numpy(state1).float())  # H
