...
from pythonML.notebooks.Pytorch.sandbox.AutoencoderUpsampleMnist import AutoencoderUpsampleMnist
...
if __name__ == '__main__':
    ...
    print(model)
    model.load_state_dict(torch.load('models/model_ae_conv_upsample_mnist.pt'))
    model.eval()
    with torch.no_grad():
