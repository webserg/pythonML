import copy
from game_of_go.dlgo.gotypes import Player
...
class Board:
    ...
    # Returns the entire string of stones at a point: a GoString if a stone is
...
class GameState:
    ...
    # Note that the Board class does permit selfcapture,
    # but in GameState you’ll enforce
